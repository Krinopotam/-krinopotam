import{r as i,j as e,D as g}from"./index-bd83bb7b.js";import{S as o,a as n,T as u,P as d,C as m,d as f}from"./docco-5da19923.js";import{I as y}from"./index-45228462.js";import"./EyeOutlined-9bf5471e.js";import"./SearchOutlined-5813b664.js";const{Title:v}=u,{TextArea:T}=y,j=()=>{const[a,r]=i.useState(""),[c,h]=i.useState(""),x=i.useCallback(l=>{r(l.target.value);const p=/(?:([a-zA-Z_]+)\s?=\s?{([а-яА-Яa-zA-Z0-9~'`"!?%@#$№^&*|[\]\\/_\-+,.:;<>=()\s\n{}]*?)}(?:\s|\/?>\s?[^{])(\/\/.*)?)|(?:\s([a-zA-Z_]+)(?:\s|\/?>\s?[^{])(\/\/.*)?[^=])/gim;let s="",t;for(;t=p.exec(l.target.value);)t[1]&&t[2]?(s=s+`
...
`;return e.jsxs(d,{children:[e.jsx("div",{children:e.jsx(j,{})}),e.jsx(g,{}),e.jsx("div",{children:e.jsx(m,{items:[{key:1,label:"Show source",children:e.jsx(o,{language:"javascript",style:a.darkMode?f:n,showLineNumbers:!0,children:r})}]})})]})};export{b as Page01c5d2aeb260475fb9d011403488f253,b as default};
