import{r as e,j as t,D as p}from"./index-7abbb94e.js";import{P as m,C as S,S as D,d as f,a as h}from"./docco-6bf51e55.js";import{B as o}from"./index-22f8d441.js";import{T as b}from"./tabulatorGrid-7e279c75.js";import{G as s}from"./tabulatorData-c70d6b23.js";import"./dFormModal-d77fb2bf.js";import"./EyeOutlined-4b705a51.js";import"./DeleteOutlined-038f7985.js";const C={resizable:"header",headerFilter:!0,headerFilterFunc:"like"},x=[{title:"Column 1",field:"col1"},{title:"Column 2",field:"col2"},{title:"Column 3",field:"col3"}],j=()=>{const[i,r]=e.useState(void 0),[a]=e.useState({}),l=e.useCallback(()=>{r(s(1e3,"state"))},[]),n=e.useCallback(()=>{a.setDataSet(s(1e3,"api"))},[a]),u=e.useCallback(()=>{a.fetchData(()=>new Promise((d,c)=>{setTimeout(()=>{Math.random()<.5?c({message:"Ошибка загрузки данных",code:400}):d({data:s(1e3,"async")})},1e3)}))},[a]);return t.jsxs(t.Fragment,{children:[t.jsx("h1",{children:"Пример обновбения dataSet грида Tabulator"}),t.jsx(o,{onClick:l,children:"Обновить DataSet через state"})," - грид целиком перерендеривается",t.jsx("br",{}),t.jsx("br",{}),t.jsx(o,{onClick:n,children:"Обновить dataSet через Api.setDataSet"})," - dataSet обновляется, но это не вызывает ререндер грида",t.jsx("br",{}),t.jsx("br",{}),t.jsx(o,{onClick:u,children:"Обновить dataSet асинхронно через Api.fetchData"})," - ререндер вызывается, так как закрывается лоадером на время загрузки, но используется мемоизированный компонет. Поэтому фактически ререндера нет.",t.jsx(b,{id:"TabulatorGridSimple",apiRef:a,columnDefaults:C,columns:x,dataSet:i,height:500,layout:"fitColumns"})]})},V=i=>{const r=`
...
`;return t.jsxs(m,{children:[t.jsx("div",{children:t.jsx(j,{})}),t.jsx(p,{}),t.jsx("div",{children:t.jsx(S,{items:[{key:1,label:"Show source",children:t.jsx(D,{language:"javascript",style:i.darkMode?f:h,showLineNumbers:!0,children:r})}]})})]})};export{V as Pagefd126d506f054f14939562866a2b6a71,V as default};
