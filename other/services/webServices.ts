...
export class WebServices {
    ...
    private putInCache<T1 extends string, T2 extends Record<string, unknown>>(
        ...
        const cacheHash = HelpersObjects.hashObjectContent(parameters || {});
    ...
    public webFetchData(props: IFetchProps): Promise<IFetchResult> {
        const _props = HelpersObjects.cloneObject(props);
        const fetchId = _props.fetchId || HelpersStrings.getUuid();
    ...
    private onRequestSuccess(
        ...
        const parametersHash = HelpersObjects.hashObjectContent(parameters || {});
