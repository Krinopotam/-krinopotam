...
const buildDemoCfg: UserConfig = {
    ...commonCfg,
    base: '/-krinopotam/ui-kit', //base URL (gitHub pages use https://krinopotam.github.io/-krinopotam/ui-kit, so URL is https://krinopotam.github.io and baseURL is /-krinopotam/ui-kit)
    build: {
        ...commonCfg.build,
        outDir:'demo-build/ui-kit',
    }
}
