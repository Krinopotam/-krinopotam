import{r as i,j as e,D as g}from"./index-239f7c99.js";import{S as o,a as n,T as u,P as m,C as d,d as f}from"./docco-df193236.js";import{I as y}from"./index-edb02d85.js";import"./EyeOutlined-6214a1a0.js";import"./SearchOutlined-cde65a1f.js";const{Title:v}=u,{TextArea:T}=y,j=()=>{const[a,r]=i.useState(""),[c,h]=i.useState(""),x=i.useCallback(l=>{r(l.target.value);const p=/(?:([a-zA-Z_]+)\s?=\s?{([а-яА-Яa-zA-Z0-9~'`"!?%@#$№^&*|[\]\\/_\-+,.:;<>=()\s\n{}]*?)}(?:\s|\/?>\s?[^{])(\/\/.*)?)|(?:\s([a-zA-Z_]+)(?:\s|\/?>\s?[^{])(\/\/.*)?[^=])/gim;let s="",t;for(;t=p.exec(l.target.value);)t[1]&&t[2]?(s=s+`
...
`;return e.jsxs(m,{children:[e.jsx("div",{children:e.jsx(j,{})}),e.jsx(g,{}),e.jsx("div",{children:e.jsx(d,{items:[{key:1,label:"Show source",children:e.jsx(o,{language:"javascript",style:a.darkMode?f:n,showLineNumbers:!0,children:r})}]})})]})};export{b as Pagec35a6e0c47f546b5915899f7f3876f2a,b as default};
