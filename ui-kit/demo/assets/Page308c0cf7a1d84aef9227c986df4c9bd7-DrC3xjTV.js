import{r,j as e,D as g}from"./index-BRcPwwbH.js";import{h as o,a as n,P as u,C as d,d as m}from"./docco-8ZfxCt3s.js";import{T as f}from"./index-Bcoz37Cc.js";import{I as y}from"./index-Bcnila5k.js";import"./EyeOutlined-CTsTM-Dg.js";import"./SearchOutlined-DcT_nl9L.js";const{Title:v}=f,{TextArea:T}=y,j=()=>{const[a,i]=r.useState(""),[c,h]=r.useState(""),x=r.useCallback(l=>{i(l.target.value);const p=/(?:([a-zA-Z_]+)\s?=\s?{([а-яА-Яa-zA-Z0-9~'`"!?%@#$№^&*|[\]\\/_\-+,.:;<>=()\s\n{}]*?)}(?:\s|\/?>\s?[^{])(\/\/.*)?)|(?:\s([a-zA-Z_]+)(?:\s|\/?>\s?[^{])(\/\/.*)?[^=])/gim;let s="",t;for(;t=p.exec(l.target.value);)t[1]&&t[2]?(s=s+`
...
`})}]})})]});export{k as Page308c0cf7a1d84aef9227c986df4c9bd7,k as default};
