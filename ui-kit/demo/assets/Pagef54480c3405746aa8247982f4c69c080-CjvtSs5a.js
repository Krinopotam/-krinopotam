import{r as a,j as t,D as p}from"./index-DpZR-xIT.js";import{P as m,C as h,h as S,d as b,a as f}from"./docco-D-QQhIhf.js";import{B as i}from"./dForm-BuCntjeb.js";import{T as D}from"./tabulatorGrid-BKCAj5bC.js";import{G as o,b as g}from"./tabulatorData-ursBOjs5.js";import"./dFormModal-CQWCZgYu.js";import"./EyeOutlined-B5uh8JXW.js";import"./DeleteOutlined-ht5ukLlu.js";const C=[{title:"Column 1",field:"col1"},{title:"Column 2",field:"col2"},{title:"Column 3",field:"col3"}],x=()=>{const[r,s]=a.useState(void 0),[e]=a.useState({}),d=a.useCallback(()=>{s(o(1e3,"state"))},[]),l=a.useCallback(()=>{e.setDataSet(o(1e3,"api"))},[e]),n=a.useCallback(()=>{e.fetchData(()=>new Promise((u,c)=>{setTimeout(()=>{Math.random()<.1?c({message:"Ошибка загрузки данных",code:400}):u({data:o(1e3,"async")})},1e3)}))},[e]);return t.jsxs(t.Fragment,{children:[t.jsx("h1",{children:"Example of updating the dataSet of the Tabulator grid"}),t.jsx(i,{onClick:d,children:"Update DataSet via setState"})," - the entire grid is re-rendered",t.jsx("br",{}),t.jsx("br",{}),t.jsx(i,{onClick:l,children:"Update dataSet via Api.setDataSet"})," - dataSet is updated, but this does not cause the grid to rerender",t.jsx("br",{}),t.jsx("br",{}),t.jsx(i,{onClick:n,children:"Update dataSet asynchronously via Api.fetchData"})," - the rerender is called because it is closed by the loader during loading, but a memoized component is used. Therefore, there is actually no rerender.",t.jsx(D,{id:"TabulatorGridSimple",apiRef:e,columnDefaults:g,columns:C,dataSet:r,height:500,layout:"fitColumns"})]})},P=r=>t.jsxs(m,{children:[t.jsx("div",{children:t.jsx(x,{})}),t.jsx(p,{}),t.jsx("div",{children:t.jsx(h,{items:[{key:1,label:"Show source",children:t.jsx(S,{language:"javascript",style:r.darkMode?b:f,showLineNumbers:!0,children:`
...
`})}]})})]});export{P as Pagef54480c3405746aa8247982f4c69c080,P as default};
