...
import{r as t,j as o,_ as s,D as n}from"./index-fLDE7RV8.js";import{b as a}from"./mergeButtons-5jDhs16v.js";import{D as m}from"./dFormModal-BONKQnKH.js";import{I as d}from"./inputField-CjWubR6e.js";import{P as l}from"./passwordField-CmCtHx2T.js";import{F as p}from"./buttonsProps-LpFfehxM.js";import{P as c,C as u,d as f,c as h}from"./darcula-BAaai0cd.js";import"./dForm-DcZj9aOC.js";import"./modal-CJqMGIFI.js";import"./index-Dm8OxE-t.js";import"./modal-DKiW44iu.js";import"./index-BoVgkjiJ.js";import"./SearchOutlined-bm7ljvup.js";const e={},x={formId:"Test form",apiRef:e,confirmChanges:!0,fieldsProps:{field1:{component:d,label:"login",tooltip:"Login input"},field2:{component:l,label:"password",tooltip:"Password input"}},onSubmit:()=>new Promise((r,i)=>{setTimeout(()=>{Math.random()<.5?i({message:"Ошибка сохранения",code:400}):r({data:{login:"new login",password:"new password"}})},3e3)}),buttons:p(e)},j=()=>{const r=t.useCallback(()=>{e.open("create")},[]);return o.jsxs(o.Fragment,{children:[o.jsx("h1",{children:"Пример сохранения данных модальной формы"}),o.jsx("p",{children:"Для обеспечения сохранения необходимо в калбэк onSubmit передать функцию, возвращающую Promise, который при успешном ответе сервера (resolve) возвращает объект вида:"}),o.jsx("code",{children:'data:{имя_поля1: "значение", имя_поля2: "значение 2"...}'}),o.jsx("p",{children:"а при ошибке (reject)"}),o.jsx("code",{children:"error:{message: string, code: number}"}),o.jsx("p",{children:"Для примера, вероятность сбоя при сохранении 50%"}),o.jsx("p",{}),o.jsxs("div",{style:{maxWidth:500},children:[o.jsx(a,{onClick:r,children:"Open form"}),o.jsx(m,{...x})]})]})},F=t.lazy(()=>s(()=>import("./index-UHTfNfHP.js").then(r=>r.ds),__vite__mapDeps([0,1,2])).then(r=>({default:r.Prism}))),L=r=>o.jsxs(c,{children:[o.jsx("div",{children:o.jsx(j,{})}),o.jsx(n,{}),o.jsx("div",{children:o.jsx(u,{items:[{key:1,label:"Show source",children:o.jsx(t.Suspense,{fallback:o.jsx("div",{children:"Loading source..."}),children:o.jsx(F,{language:"tsx",style:r.darkMode?f:h,showLineNumbers:!0,children:`
...
`})})}]})})]});export{L as Page7615b5a1879049d9b9d86505d24aca2f,L as default};
