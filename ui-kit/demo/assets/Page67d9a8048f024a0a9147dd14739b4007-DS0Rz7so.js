...
import{j as e,r as a,_ as l,D as n}from"./index-C4KfxKt0.js";import{D as p}from"./dForm-DkkmO2de.js";import{T as i}from"./treeSelectField-DQqIU8U1.js";import{P as c,C as m,d as S,c as u}from"./darcula-Dn2EXRAk.js";import"./modal-B9kdAnYE.js";import"./index-kYmYzKiJ.js";import"./dFormModal-NILuEzR7.js";import"./modal-DhSU9O67.js";import"./defaultButtonsProps-DB_b1JyB.js";import"./useApiGetGroupsOnly-Di3cbyaq.js";import"./useShowArrow-Bin-bzmW.js";import"./useIcons-Dh6q2bL1.js";import"./SearchOutlined-1XjRaxWd.js";const f=[{id:"1",title:"First"},{id:"2",title:"Second"},{id:"3",title:"Third"}],h=[{id:"1",title:"First type process 1"},{id:"2",title:"First type process 2"}],F=[{id:"3",title:"Second type process 1"},{id:"4",title:"Second type process 2"}],x=()=>{const t=P();return e.jsxs("div",{children:[e.jsx("h1",{children:"An example of a form with TreeSelect fields, the data set of one of which depends on the selection in the other"}),e.jsx("div",{style:{maxWidth:500},children:e.jsx(p,{...t})})]})},P=()=>({formId:"TestForm",confirmChanges:!0,fieldsProps:{tip:{component:i,label:"Process type",fetchMode:"onUse",dataSet:f,onValueChanged:(t,d,r)=>{const s=r.getValue();let o;if(s?s.id==="1"?o=h:s.id==="2"?o=F:o=[]:o=[],!o)return;r.getModel().getField("process").updateProps({dataSet:o})}},process:{component:i,label:"Process",fetchMode:"onUse",dataSet:[{}]}},buttons:{ok:{position:"right"}}}),y=a.lazy(()=>l(()=>import("./index-HHVvrn9L.js").then(t=>t.ds),__vite__mapDeps([0,1,2])).then(t=>({default:t.Prism}))),R=t=>e.jsxs(c,{children:[e.jsx("div",{children:e.jsx(x,{})}),e.jsx(n,{}),e.jsx("div",{children:e.jsx(m,{items:[{key:1,label:"Show source",children:e.jsx(a.Suspense,{fallback:e.jsx("div",{children:"Loading source..."}),children:e.jsx(y,{language:"tsx",style:t.darkMode?S:u,showLineNumbers:!0,children:`
...
`})})}]})})]});export{R as Page67d9a8048f024a0a9147dd14739b4007,R as default};
