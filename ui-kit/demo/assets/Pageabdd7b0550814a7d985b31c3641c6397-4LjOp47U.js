...
import{r as l,j as t,_ as d,D as p}from"./index-Dv3qFdjW.js";import{B as c}from"./modal-Bp_ASPGm.js";import{D as u}from"./dFormModal-BUbiUSeF.js";import{T as f}from"./tabulatorGridField-B2bifJ-i.js";import{I as r}from"./inputField-C4gwpQCw.js";import{F as s}from"./buttonsProps-CSAEaPaH.js";import{T as F,G as a}from"./tabulatorData-LW4kGiGF.js";import{P as h,C as g,d as b,c as D}from"./darcula-MphVyLu8.js";import"./dForm-QxcKLYQQ.js";import"./index-8gx4Y1o-.js";import"./modal-DoluWT5v.js";import"./tabulatorGrid-COGwSkTc.js";import"./defaultButtonsProps-DchoBAIh.js";import"./index-CWJIcpxl.js";import"./index-qOGxHuln.js";import"./SearchOutlined-DCaoIkCx.js";const C=[{title:"Column 1",field:"col1"},{title:"Column 2",field:"col2"},{title:"Column 3",field:"col3"}],e={},n={},S={apiRef:n,formId:"formWithGrid",fieldsProps:{col1:{component:r,label:"Column 1"},col2:{component:r,label:"Column 2"},col3:{component:r,label:"Column 3"}},confirmChanges:!0,buttons:s(n)},m={},k={formId:"Test form",apiRef:e,confirmChanges:!0,height:500,width:"50%",fieldsProps:{grid:{component:f,apiRef:m,label:"Пользователи",columnDefaults:F,columns:C,layout:"fitColumns",autoHeightResize:!0,editFormProps:S,confirmDelete:!0}},buttons:{...s(e),updateDataSet:{type:"button",title:"Update DataSet",position:"center",onClick:()=>{e.model.getField("grid").setValue(a(1e3,"Set field Value "))}},asyncUpdateDataSet:{type:"button",title:"Async update DataSet",position:"center",onClick:()=>{m.fetchData(()=>new Promise((o,i)=>{setTimeout(()=>{Math.random()<.1?i({message:"Ошибка загрузки данных",code:400}):o({data:a(1e3,"async ")})},1e3)}))}},clearDataSet:{type:"button",title:"Clear DataSet",position:"center",onClick:()=>{e.model.getField("grid").setValue([])}}}},y=()=>{const o=l.useCallback(()=>{e.open("update",{dataSet:{grid:a(1e3,"Initial ")}})},[]);return t.jsxs(t.Fragment,{children:[t.jsx("h1",{children:"Example of a modal form with a TabulatorGrid field"}),t.jsxs("div",{style:{maxWidth:500},children:[t.jsx(c,{onClick:o,children:"Open form"}),t.jsx(u,{...k})]})]})},P=l.lazy(()=>d(()=>import("./index-Co9PZaPl.js").then(o=>o.ds),__vite__mapDeps([0,1,2])).then(o=>({default:o.Prism}))),U=o=>t.jsxs(h,{children:[t.jsx("div",{children:t.jsx(y,{})}),t.jsx(p,{}),t.jsx("div",{children:t.jsx(g,{items:[{key:1,label:"Show source",children:t.jsx(l.Suspense,{fallback:t.jsx("div",{children:"Loading source..."}),children:t.jsx(P,{language:"tsx",style:o.darkMode?b:D,showLineNumbers:!0,children:`
...
`})})}]})})]});export{U as Pageabdd7b0550814a7d985b31c3641c6397,U as default};
