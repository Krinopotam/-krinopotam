import{r,j as e,D as g}from"./index-C88KkuCB.js";import{h as o,a as n,P as u,C as m,d}from"./docco-ByJX3Scg.js";import{T as f}from"./index-BuXson94.js";import{I as y}from"./index-CCZkxA_l.js";import"./EyeOutlined-RPGYlChj.js";import"./SearchOutlined-B0z9pdPP.js";const{Title:v}=f,{TextArea:T}=y,j=()=>{const[a,i]=r.useState(""),[c,h]=r.useState(""),x=r.useCallback(l=>{i(l.target.value);const p=/(?:([a-zA-Z_]+)\s?=\s?{([а-яА-Яa-zA-Z0-9~'`"!?%@#$№^&*|[\]\\/_\-+,.:;<>=()\s\n{}]*?)}(?:\s|\/?>\s?[^{])(\/\/.*)?)|(?:\s([a-zA-Z_]+)(?:\s|\/?>\s?[^{])(\/\/.*)?[^=])/gim;let s="",t;for(;t=p.exec(l.target.value);)t[1]&&t[2]?(s=s+`
...
`})}]})})]});export{k as Page1347f0b6e6084f68b7e9ba4f3815502c,k as default};
