...
import{r,j as t,_ as h,D as f}from"./index-BvGUw9C6.js";import{B as S}from"./modal-DNjBPuEU.js";import{T as x}from"./tabulatorGrid-YoC4snix.js";import{G as P,T as D}from"./tabulatorData-7wwdtTXj.js";import{P as y,C as z,d as b,c as j}from"./darcula-ztsHFdQx.js";import"./dForm-CuoIYVbt.js";import"./index-D8Aqgh10.js";import"./dFormModal-DG3y0daw.js";import"./modal-CFEDQlJ_.js";import"./defaultButtonsProps-CC5Jyskk.js";import"./index-Bb6r_g7-.js";const A=[{title:"Column 1",field:"col1"},{title:"Column 2",field:"col2"},{title:"Column 3",field:"col3"}],s=P(1e4,"async"),C=()=>{const[a]=r.useState({}),u=r.useCallback(()=>{a.fetchData(e=>(console.log("params",e),new Promise((n,l)=>{setTimeout(()=>{Math.random()<.5&&l({message:"Loading error",code:400});const c=(e==null?void 0:e.page)??1,o=(e==null?void 0:e.size)??a.getProps().paginationSize??10,i=Math.ceil(s.length/o),d=s.slice((c-1)*o,c*o);n({data:d,last_page:i})},1e3)})),{manualParam:"manualValue"})},[a]),m={apiRef:a,columnDefaults:D,columns:A,height:500,pagination:!0,paginationSize:10,paginationSizeSelector:[5,10,50,100],paginationCounter:"rows",paginationMode:"remote",filterMode:"remote",sortMode:"remote",onDataFetch:(e,n)=>(console.log("params",e),new Promise((l,p)=>{setTimeout(()=>{Math.random()<.5&&p({message:"Loading error",code:400});const o=(e==null?void 0:e.page)??1,i=(e==null?void 0:e.size)??n.getProps().paginationSize??10,d=Math.ceil(s.length/i),g=s.slice((o-1)*i,o*i);l({data:g,last_page:d})},1e3)})),ajaxParams:{extraKey1:"extraValue1",extraKey2:"extraValue2"}};return t.jsxs(t.Fragment,{children:[t.jsx("h1",{children:"Force asynchronous update of the TabulatorGrid dataset in the page mode"}),t.jsx("p",{style:{color:"red"},children:"To test boot resumption there is a 50/50 chance of error"}),t.jsx(S,{onClick:u,children:"Update dataSet asynchronously via Api.fetchData"}),t.jsx(x,{...m})]})},M=r.lazy(()=>h(()=>import("./index-0uqxO8u4.js").then(a=>a.ds),__vite__mapDeps([0,1,2])).then(a=>({default:a.Prism}))),R=a=>t.jsxs(y,{children:[t.jsx("div",{children:t.jsx(C,{})}),t.jsx(f,{}),t.jsx("div",{children:t.jsx(z,{items:[{key:1,label:"Show source",children:t.jsx(r.Suspense,{fallback:t.jsx("div",{children:"Loading source..."}),children:t.jsx(M,{language:"tsx",style:a.darkMode?b:j,showLineNumbers:!0,children:`
...
`})})}]})})]});export{R as Page1ff1d17778bb41ad8fd7cd96e8e422a3,R as default};
