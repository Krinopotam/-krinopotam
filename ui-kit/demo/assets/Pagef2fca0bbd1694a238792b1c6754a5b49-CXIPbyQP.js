...
import{j as e,D as u,r as m,_ as c}from"./index-B5poLpDm.js";import{T as d}from"./tabulatorGrid-igE2XdiX.js";import{c as f,D as h}from"./tabulatorData-BmpfO34x.js";import{P as p,C as w,d as b,c as D}from"./darcula-DszBWugp.js";import"./buttonsRow-aX3TQ5bu.js";import"./dForm-vrGhQ6Lh.js";import"./messageBox-1o2XjDyt.js";import"./index-AMqWlYeY.js";import"./dFormModal-C_QqbNS_.js";import"./modal-tHBgt86o.js";import"./defaultButtonsProps-DtqWhfDr.js";import"./PlusOutlined-Bg-hNKo-.js";import"./index--2ky6TFp.js";const $=r=>{const t=r.getRow().getData();return`<span>${t.surname} ${t.name} ${t.patronymic}</span><br/><small style="color:#808080;">${t.email}</small>`},F=(r,n,t)=>`${t.surname} ${t.name} ${t.patronymic} (${t.email})`.toLowerCase().indexOf(r.toLowerCase())>=0,g=(r,n,t,l)=>{const a=t.getData(),o=l.getData(),i=`${a.surname} ${a.name} ${a.patronymic} (${a.email})`,s=`${o.surname} ${o.name} ${o.patronymic} (${o.email})`;return i===s?0:i>s?1:-1},y={resizable:"header",headerFilter:!0,headerFilterFunc:"like"},x=[{title:"ФИО",field:"fio",formatter:$,headerFilterFunc:F,sorter:g,headerFilter:void 0},{title:"День рождения",field:"birthday",sorter:h,headerFilter:void 0}],T=()=>{const r={id:"TabulatorGridCellFormat",columnDefaults:y,columns:x,dataSet:f,height:500};return e.jsxs(e.Fragment,{children:[e.jsx("h1",{children:"Пример грида Tabulator с настраиваемым отображением ячеек"}),e.jsx("p",{children:"В данном примере в ячейке столбца ФИО отображаются данные из полей surname, name, patronymic и email"}),e.jsx("p",{children:"Фильтр и сортировка производятся по каждому из этих полей"}),e.jsx(d,{...r})]})},P=m.lazy(()=>c(()=>import("./index-DJhjoKXt.js").then(r=>r.dw),__vite__mapDeps([0,1,2])).then(r=>({default:r.Prism}))),V=r=>e.jsxs(p,{children:[e.jsx("div",{children:e.jsx(T,{})}),e.jsx(u,{}),e.jsx("div",{children:e.jsx(w,{items:[{key:1,label:"Show source",children:e.jsx(m.Suspense,{fallback:e.jsx("div",{children:"Loading source..."}),children:e.jsx(P,{language:"tsx",style:r.darkMode?b:D,showLineNumbers:!0,children:`
...
`})})}]})})]});export{V as Pagef2fca0bbd1694a238792b1c6754a5b49,V as default};
