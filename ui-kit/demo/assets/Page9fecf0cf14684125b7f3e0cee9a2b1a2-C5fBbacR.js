...
import{j as e,r as m,_ as c,D as u}from"./index-1vveH9ac.js";import{T as d}from"./tabulatorGrid-D5G9O9wz.js";import{T as f,g as h,D as p}from"./tabulatorData-DQ2nqhzb.js";import{P as w,C as D,d as b,c as $}from"./darcula-DpQ7T8l_.js";import"./mergeButtons-DTGr5PDV.js";import"./dForm-D5DpcrSR.js";import"./modal-DQmoWYEp.js";import"./index-X3DQSWWD.js";import"./dFormModal-0jOrNNg7.js";import"./modal-CIPFU5OD.js";import"./defaultButtonsProps-BsF6dd38.js";import"./index-ClZuhHMx.js";const T=a=>{const t=a.getRow().getData();return`<span>${t.surname} ${t.name} ${t.patronymic}</span><br/><small style="color:#808080;">${t.email}</small>`},g=(a,n,t)=>`${t.surname} ${t.name} ${t.patronymic} (${t.email})`.toLowerCase().indexOf(a.toLowerCase())>=0,y=(a,n,t,s)=>{const r=t.getData(),o=s.getData(),l=`${r.surname} ${r.name} ${r.patronymic} (${r.email})`,i=`${o.surname} ${o.name} ${o.patronymic} (${o.email})`;return l===i?0:l>i?1:-1},x=[{title:"ФИО",field:"fio",formatter:T,headerFilterFunc:g,sorter:y},{title:"День рождения",field:"birthday",sorter:p}],F={id:"TabulatorGridTreeCellFormat",columnDefaults:f,columns:x,dataSet:h,dataTree:!0,height:500,layout:"fitColumns"},v=()=>e.jsxs(e.Fragment,{children:[e.jsx("h1",{children:"Example of a hierarchical Tabulator grid with customizable cell display"}),e.jsx("p",{children:"In this example, the cell in the full name column displays data from the fields surname, name, patronymic and email"}),e.jsx("p",{children:"Filter and sort are calculated for each of these fields"}),e.jsx(d,{...F})]}),C=m.lazy(()=>c(()=>import("./index-BL7bdWBR.js").then(a=>a.ds),__vite__mapDeps([0,1,2])).then(a=>({default:a.Prism}))),I=a=>e.jsxs(w,{children:[e.jsx("div",{children:e.jsx(v,{})}),e.jsx(u,{}),e.jsx("div",{children:e.jsx(D,{items:[{key:1,label:"Show source",children:e.jsx(m.Suspense,{fallback:e.jsx("div",{children:"Loading source..."}),children:e.jsx(C,{language:"tsx",style:a.darkMode?b:$,showLineNumbers:!0,children:`
...
`})})}]})})]});export{I as Page9fecf0cf14684125b7f3e0cee9a2b1a2,I as default};
