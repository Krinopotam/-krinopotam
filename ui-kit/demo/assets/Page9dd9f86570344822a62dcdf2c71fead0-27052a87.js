import{r as i,j as e,D as g}from"./index-491b5652.js";import{S as o,a as n,T as u,P as d,C as m,d as f}from"./docco-2ccfe26d.js";import{I as y}from"./index-92c2cdb7.js";import"./EyeOutlined-ab0d6fcf.js";import"./SearchOutlined-62734d32.js";const{Title:v}=u,{TextArea:T}=y,j=()=>{const[a,r]=i.useState(""),[c,h]=i.useState(""),x=i.useCallback(l=>{r(l.target.value);const p=/(?:([a-zA-Z_]+)\s?=\s?{([а-яА-Яa-zA-Z0-9~'`"!?%@#$№^&*|[\]\\/_\-+,.:;<>=()\s\n{}]*?)}(?:\s|\/?>\s?[^{])(\/\/.*)?)|(?:\s([a-zA-Z_]+)(?:\s|\/?>\s?[^{])(\/\/.*)?[^=])/gim;let s="",t;for(;t=p.exec(l.target.value);)t[1]&&t[2]?(s=s+`
...
`;return e.jsxs(d,{children:[e.jsx("div",{children:e.jsx(j,{})}),e.jsx(g,{}),e.jsx("div",{children:e.jsx(m,{items:[{key:1,label:"Show source",children:e.jsx(o,{language:"javascript",style:a.darkMode?f:n,showLineNumbers:!0,children:r})}]})})]})};export{k as Page9dd9f86570344822a62dcdf2c71fead0,k as default};
