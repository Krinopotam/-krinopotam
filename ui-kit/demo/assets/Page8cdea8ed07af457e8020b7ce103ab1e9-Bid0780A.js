...
import{R as s,j as e,S as d,a,r,_ as p,D as m}from"./index-fLDE7RV8.js";import{D as c}from"./dForm-DcZj9aOC.js";import{I as i}from"./inputField-CjWubR6e.js";import{P as h,C as f,d as u,c as F}from"./darcula-BAaai0cd.js";import"./mergeButtons-5jDhs16v.js";import"./modal-CJqMGIFI.js";import"./index-Dm8OxE-t.js";import"./index-BoVgkjiJ.js";import"./SearchOutlined-bm7ljvup.js";const x=()=>{const[o,t]=s.useState(!1),l=b(o);return e.jsxs(e.Fragment,{children:[e.jsx("h1",{children:"An example of a form with fields whose visibility depends on each other"}),e.jsx("p",{children:"While the parent field is empty, dependent fields are hidden"}),e.jsxs("div",{style:{maxWidth:500},children:[e.jsx(d,{style:{marginBottom:30},children:e.jsx(a,{checkedChildren:"Horizontal",unCheckedChildren:"Vertical",onChange:()=>t(n=>!n)})}),e.jsx(c,{...l})]})]})},b=o=>({formId:"Test form",layout:o?"horizontal":"vertical",confirmChanges:!0,fieldsProps:{field1:{component:i,label:"Field 1",placeholder:"While I am empty, other fields are not visible"},field2:{component:i,label:"Field 2 (depends on Field 1)",placeholder:"I can't be seen if Field 1 is empty. Enter something",dependsOn:["field1"]},field3:{component:i,label:"Field 3 (depends on Fields 1 and 2)",placeholder:"I am not visible if fields 1 or 2 are empty",dependsOn:["field1","field2"]}},buttons:{ok:{position:"right"}}}),y=r.lazy(()=>p(()=>import("./index-UHTfNfHP.js").then(o=>o.ds),__vite__mapDeps([0,1,2])).then(o=>({default:o.Prism}))),D=o=>e.jsxs(h,{children:[e.jsx("div",{children:e.jsx(x,{})}),e.jsx(m,{}),e.jsx("div",{children:e.jsx(f,{items:[{key:1,label:"Show source",children:e.jsx(r.Suspense,{fallback:e.jsx("div",{children:"Loading source..."}),children:e.jsx(y,{language:"tsx",style:o.darkMode?u:F,showLineNumbers:!0,children:`
...
`})})}]})})]});export{D as Page8cdea8ed07af457e8020b7ce103ab1e9,D as default};
