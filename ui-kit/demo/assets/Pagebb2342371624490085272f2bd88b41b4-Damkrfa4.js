import{j as o,D as C}from"./index-CEW5Pw51.js";import{P as V,C as B,h as L,d as w,a as G}from"./docco-BDmKSriJ.js";import{T as O}from"./tabulatorGrid-D_Dw4JJ8.js";import{b as P,a as z,e as I,D as $}from"./tabulatorData-CS8n7XKW.js";import{q as T}from"./index-XDwG7I6Z.js";import"./dFormModal-CQxmvlme.js";import"./EyeOutlined-CTrlI0WT.js";import"./DeleteOutlined-DC7B5UxI.js";const A=(n,u,Y,c,r)=>{const t=document.createElement("input"),a=document.createElement("input"),p=n.getColumn();p.getDefinition().headerFilterLiveFilter=!1;let m=n.getValue();const l=m.split(" - "),s=l[0]??"",d=l[1]??"",F=e=>{const f=t.value,x=a.value,H=e?f:x,v=e?s:d;if(v&&H===v){c(void 0);return}const D=f+" - "+x;Y(D)&&(console.log(D),m=D)},g=(e,f)=>{e.relatedTarget&&F(f)},M=e=>{g(e,!0)},k=e=>{g(e,!1)},h=(e,f)=>{switch(e.keyCode){case 13:F(f);break;case 27:c(void 0);break;case 35:case 36:e.stopPropagation();break}},S=e=>{h(e,!0)},E=e=>{h(e,!1)},i=document.createElement("div");i.style.display="flex",i.style.flexDirection="row",i.addEventListener("keyup",e=>{e.stopPropagation()}),i.addEventListener("search",e=>{e.stopPropagation()});const b=(r==null?void 0:r.filterType)==="datetime"?"datetime-local":"date",y=(r==null?void 0:r.filterType)==="datetime"&&(r!=null&&r.showSeconds)?"1":"";t.value=s,t.type=b,t.step=y,t.style.flex="1",t.style.padding="4px",t.style.marginLeft="6px",t.style.marginRight="6px",t.style.boxSizing="border-box",t.addEventListener("blur",M),t.addEventListener("keydown",S),a.value=d,a.type=b,a.step=y,a.style.flex="1",a.style.padding="4px",a.style.marginLeft="6px",a.style.boxSizing="border-box",a.addEventListener("blur",k),a.addEventListener("keydown",E);const R=document.createTextNode("с"),j=document.createTextNode("по");return i.appendChild(R),i.appendChild(t),i.appendChild(j),i.appendChild(a),u(function(){n.getType()==="cell"&&(t.focus({preventScroll:!0}),t.select())}),i},K=(n,u,Y,c)=>{if(!n)return!0;if(!u)return!!c.keepEmpty;const r=n.split(" - "),t=r[0],a=r[1],p=T(t),m=T(a);if(!p.isValid()&&!m.isValid())return!0;let l=c.valuesFormat;l||(u.length===10?l="DD.MM.YYYY":u.length===16?l="DD.MM.YYYY HH:mm":l="DD.MM.YYYY HH:mm:ss");const s=T(u,l);if(!s.isValid())return!!c.keepEmpty;let d;return p.isValid()&&(d=s.isAfter(p)||s.isSame(p)),m.isValid()&&d!==!1&&(d=s.isBefore(m)||s.isSame(m)),!!d},N=[{title:"Date Of Birth",field:"dob",hozAlign:"center",headerFilter:A,headerFilterFunc:K,headerFilterFuncParams:{filterType:"date",valuesFormat:"DD/MM/YYYY"},formatter:I,formatterParams:{inputFormat:"DD/MM/YYYY",outputFormat:"DD.MM.YYYY"},sorter:$,sorterParams:{format:"DD/MM/YYYY"}}],q={id:"TabulatorGridSimple",columnDefaults:P,columns:N,dataSet:z,height:500},J=()=>o.jsxs(o.Fragment,{children:[o.jsx("h1",{children:"The Tabulator DataRangeHeaderFilter example"}),o.jsx(O,{...q})]}),ae=n=>o.jsxs(V,{children:[o.jsx("div",{children:o.jsx(J,{})}),o.jsx(C,{}),o.jsx("div",{children:o.jsx(B,{items:[{key:1,label:"Show source",children:o.jsx(L,{language:"javascript",style:n.darkMode?w:G,showLineNumbers:!0,children:`
...
`})}]})})]});export{ae as Pagebb2342371624490085272f2bd88b41b4,ae as default};
