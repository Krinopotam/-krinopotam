import{r,j as e,D as g}from"./index-DpZR-xIT.js";import{h as o,a as n,T as u,P as d,C as m,d as f}from"./docco-D-QQhIhf.js";import{I as y}from"./index-Cb1flwDV.js";import"./EyeOutlined-B5uh8JXW.js";import"./SearchOutlined-C5XLlk3g.js";const{Title:v}=u,{TextArea:T}=y,j=()=>{const[a,i]=r.useState(""),[c,h]=r.useState(""),x=r.useCallback(l=>{i(l.target.value);const p=/(?:([a-zA-Z_]+)\s?=\s?{([а-яА-Яa-zA-Z0-9~'`"!?%@#$№^&*|[\]\\/_\-+,.:;<>=()\s\n{}]*?)}(?:\s|\/?>\s?[^{])(\/\/.*)?)|(?:\s([a-zA-Z_]+)(?:\s|\/?>\s?[^{])(\/\/.*)?[^=])/gim;let s="",t;for(;t=p.exec(l.target.value);)t[1]&&t[2]?(s=s+`
...
`})}]})})]});export{b as Pagec08088b3d52f474cb0a4c55898e38e06,b as default};
