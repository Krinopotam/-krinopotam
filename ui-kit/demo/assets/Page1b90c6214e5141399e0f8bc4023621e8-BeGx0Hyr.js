import{j as e,D as m}from"./index-zp8t8nBI.js";import{P as u,C as c,h as d,d as f,a as h}from"./docco-qM7CaTt5.js";import{T as p}from"./tabulatorGrid-LGmx6kUr.js";import{c as w,D}from"./tabulatorData-BJ5jlgxT.js";import"./dForm-CtyM7E66.js";import"./dFormModal-DQXWVkWJ.js";import"./EyeOutlined-B9jVFvSG.js";import"./DeleteOutlined-oAPYnq6c.js";const b=t=>{const r=t.getRow().getData();return`<span>${r.surname} ${r.name} ${r.patronymic}</span><br/><small style="color:#808080;">${r.email}</small>`},$=(t,l,r)=>`${r.surname} ${r.name} ${r.patronymic} (${r.email})`.toLowerCase().indexOf(t.toLowerCase())>=0,F=(t,l,r,n)=>{const a=r.getData(),o=n.getData(),s=`${a.surname} ${a.name} ${a.patronymic} (${a.email})`,i=`${o.surname} ${o.name} ${o.patronymic} (${o.email})`;return s===i?0:s>i?1:-1},g={resizable:"header",headerFilter:!0,headerFilterFunc:"like"},y=[{title:"ФИО",field:"fio",formatter:b,headerFilterFunc:$,sorter:F,headerFilter:void 0},{title:"День рождения",field:"birthday",sorter:D,headerFilter:void 0}],T=()=>{const t={id:"TabulatorGridCellFormat",columnDefaults:g,columns:y,dataSet:w,height:500};return e.jsxs(e.Fragment,{children:[e.jsx("h1",{children:"Пример грида Tabulator с настраиваемым отображением ячеек"}),e.jsx("p",{children:"В данном примере в ячейке столбца ФИО отображаются данные из полей surname, name, patronymic и email"}),e.jsx("p",{children:"Фильтр и сортировка расчитываются по каждому из этих полей"}),e.jsx(p,{...t})]})},k=t=>e.jsxs(u,{children:[e.jsx("div",{children:e.jsx(T,{})}),e.jsx(m,{}),e.jsx("div",{children:e.jsx(c,{items:[{key:1,label:"Show source",children:e.jsx(d,{language:"javascript",style:t.darkMode?f:h,showLineNumbers:!0,children:`
...
`})}]})})]});export{k as Page1b90c6214e5141399e0f8bc4023621e8,k as default};
