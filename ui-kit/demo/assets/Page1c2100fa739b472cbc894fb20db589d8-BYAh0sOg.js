...
import{j as e,r as m,_ as c,D as u}from"./index-DKsnjJVp.js";import{T as d}from"./tabulatorGrid-DCOzFUIF.js";import{T as f,g as h,D as p}from"./tabulatorData-Dp7qYVQO.js";import{P as w,C as b,d as D,c as $}from"./darcula-CbhncTMN.js";import"./modal-s_O7aRct.js";import"./dForm-RzxzTjHO.js";import"./index-CSyocx7G.js";import"./dFormModal-BxobeehR.js";import"./modal-sKRn3jmz.js";import"./defaultButtonsProps-Bo_d-5AQ.js";import"./index-CxCukQln.js";const T=a=>{const t=a.getRow().getData();return`<span>${t.surname} ${t.name} ${t.patronymic}</span><br/><small style="color:#808080;">${t.email}</small>`},g=(a,n,t)=>`${t.surname} ${t.name} ${t.patronymic} (${t.email})`.toLowerCase().indexOf(a.toLowerCase())>=0,y=(a,n,t,s)=>{const r=t.getData(),o=s.getData(),l=`${r.surname} ${r.name} ${r.patronymic} (${r.email})`,i=`${o.surname} ${o.name} ${o.patronymic} (${o.email})`;return l===i?0:l>i?1:-1},x=[{title:"ФИО",field:"fio",formatter:T,headerFilterFunc:g,sorter:y},{title:"День рождения",field:"birthday",sorter:p}],F={id:"TabulatorGridTreeCellFormat",columnDefaults:f,columns:x,dataSet:h,dataTree:!0,height:500,layout:"fitColumns"},v=()=>e.jsxs(e.Fragment,{children:[e.jsx("h1",{children:"Example of a hierarchical Tabulator grid with customizable cell display"}),e.jsx("p",{children:"In this example, the cell in the full name column displays data from the fields surname, name, patronymic and email"}),e.jsx("p",{children:"Filter and sort are calculated for each of these fields"}),e.jsx(d,{...F})]}),C=m.lazy(()=>c(()=>import("./index-Cz0v0Rp9.js").then(a=>a.ds),__vite__mapDeps([0,1,2])).then(a=>({default:a.Prism}))),E=a=>e.jsxs(w,{children:[e.jsx("div",{children:e.jsx(v,{})}),e.jsx(u,{}),e.jsx("div",{children:e.jsx(b,{items:[{key:1,label:"Show source",children:e.jsx(m.Suspense,{fallback:e.jsx("div",{children:"Loading source..."}),children:e.jsx(C,{language:"tsx",style:a.darkMode?D:$,showLineNumbers:!0,children:`
...
`})})}]})})]});export{E as Page1c2100fa739b472cbc894fb20db589d8,E as default};
