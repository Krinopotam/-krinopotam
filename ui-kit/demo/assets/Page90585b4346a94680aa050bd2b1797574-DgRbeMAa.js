...
import{j as e,r as a,_ as l,D as n}from"./index-Dv3qFdjW.js";import{D as p}from"./dForm-QxcKLYQQ.js";import{T as i}from"./treeSelectField-BUD0w8Bo.js";import{P as c,C as m,d as S,c as u}from"./darcula-MphVyLu8.js";import"./modal-Bp_ASPGm.js";import"./index-8gx4Y1o-.js";import"./dFormModal-BUbiUSeF.js";import"./modal-DoluWT5v.js";import"./defaultButtonsProps-DchoBAIh.js";import"./useShowArrow-CHTHTBiw.js";import"./useIcons-CEssDIMU.js";import"./SearchOutlined-DCaoIkCx.js";import"./useApiIsNodeSelected-CouYiEi1.js";const f=[{id:"1",title:"First"},{id:"2",title:"Second"},{id:"3",title:"Third"}],h=[{id:"1",title:"First type process 1"},{id:"2",title:"First type process 2"}],F=[{id:"3",title:"Second type process 1"},{id:"4",title:"Second type process 2"}],x=()=>{const t=P();return e.jsxs("div",{children:[e.jsx("h1",{children:"An example of a form with TreeSelect fields, the data set of one of which depends on the selection in the other"}),e.jsx("div",{style:{maxWidth:500},children:e.jsx(p,{...t})})]})},P=()=>({formId:"TestForm",confirmChanges:!0,fieldsProps:{tip:{component:i,label:"Process type",fetchMode:"onUse",dataSet:f,onValueChanged:(t,d,r)=>{const s=r.getValue();let o;if(s?s.id==="1"?o=h:s.id==="2"?o=F:o=[]:o=[],!o)return;r.getModel().getField("process").updateProps({dataSet:o})}},process:{component:i,label:"Process",fetchMode:"onUse",dataSet:[{}]}},buttons:{ok:{position:"right"}}}),y=a.lazy(()=>l(()=>import("./index-Co9PZaPl.js").then(t=>t.ds),__vite__mapDeps([0,1,2])).then(t=>({default:t.Prism}))),R=t=>e.jsxs(c,{children:[e.jsx("div",{children:e.jsx(x,{})}),e.jsx(n,{}),e.jsx("div",{children:e.jsx(m,{items:[{key:1,label:"Show source",children:e.jsx(a.Suspense,{fallback:e.jsx("div",{children:"Loading source..."}),children:e.jsx(y,{language:"tsx",style:t.darkMode?S:u,showLineNumbers:!0,children:`
...
`})})}]})})]});export{R as Page90585b4346a94680aa050bd2b1797574,R as default};
