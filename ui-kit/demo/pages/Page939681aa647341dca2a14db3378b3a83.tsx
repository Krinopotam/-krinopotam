    ...
    import {TabulatorGridSimple} from '../components/tabulatorGrid/tabulatorGridSimple';
    import { Divider, Collapse } from 'antd';
    import SyntaxHighlighter from 'react-syntax-highlighter';
    import {darcula, docco} from 'react-syntax-highlighter/dist/esm/styles/hljs';

    export const Page939681aa647341dca2a14db3378b3a83 = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
    const source = `
import React from 'react';
...
export default Page939681aa647341dca2a14db3378b3a83;
