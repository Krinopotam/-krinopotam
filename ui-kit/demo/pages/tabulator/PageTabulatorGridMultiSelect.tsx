    ...
    export const PageTabulatorGridMultiSelect = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
    const source = `
import React from 'react';
...
const columns: ITabulatorProps['columns'] = [
    ...
    {title: 'Date Of Birth', field: 'dob', hozAlign: 'center', formatter: 'datetime', formatterParams: {inputFormat: 'DD/MM/YYYY', outputFormat: 'DD.MM.YYYY'}, sorter: dateTimeSorter, sorterParams: {format: 'DD/MM/YYYY'}},
...
const dataSet: IGridRowData[] = [
    ...
    {id: '5', name: 'Margret Marmajuke1', age: '16', col: 'yellow', dob: '02/01/1999', rating: 3, passed: true},
...
export const TabulatorGridMultiSelect = (): React.JSX.Element => {
    return (
        <>
            <TabulatorGrid id={'TabulatorGridSimple'} columnDefaults={columnDefaults} columns={columns} dataSet={dataSet} multiSelect={true} height={500} layout={'fitColumns'}/>
        </>
    );
};
`
...
export default PageTabulatorGridMultiSelect;
