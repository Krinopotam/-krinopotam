    ...
    import {TreeSelectWithForm} from '../components/treeSelect/treeSelectWithForm';
    import { Divider, Collapse } from 'antd';
    import SyntaxHighlighter from 'react-syntax-highlighter';
    import {darcula, docco} from 'react-syntax-highlighter/dist/esm/styles/hljs';

    export const Page5b4f0f2d77784e3c922ee3a1b8e909ff = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
    const source = `
import React from 'react';
...
export default Page5b4f0f2d77784e3c922ee3a1b8e909ff;
