    ...
    import {TabulatorGridTreeCellFormat} from '../components/tabulatorGrid/tabulatorGridTreeCellFormat';
    import { Divider, Collapse } from 'antd';
    import SyntaxHighlighter from 'react-syntax-highlighter';
    import {darcula, docco} from 'react-syntax-highlighter/dist/esm/styles/hljs';

    export const Page1e3dd73563b44662afb631211416a123 = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
    const source = `
import React from 'react';
...
export default Page1e3dd73563b44662afb631211416a123;
