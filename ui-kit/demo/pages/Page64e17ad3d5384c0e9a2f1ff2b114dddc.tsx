    ...
    import {TabulatorGridWithFormAsync} from '../components/tabulatorGrid/tabulatorGridWithFormAsync';
    import { Divider, Collapse } from 'antd';
    import SyntaxHighlighter from 'react-syntax-highlighter';
    import {darcula, docco} from 'react-syntax-highlighter/dist/esm/styles/hljs';

    export const Page64e17ad3d5384c0e9a2f1ff2b114dddc = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
    const source = `
import React from 'react';
...
export default Page64e17ad3d5384c0e9a2f1ff2b114dddc;
