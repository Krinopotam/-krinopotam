    ...
    export const TreeSelectNodeRenderPage = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
...
import {ITreeSelectNode, IDFormFieldTreeSelectProps} from "@src/dynamic-form/components/treeSelectComponent";
