    ...
    import {TreeSelectWithFormAndNodeRenderers} from '../../components/treeSelect/withFormAndNodeRenderers';
    import { Divider, Collapse } from 'antd';
    import SyntaxHighlighter from 'react-syntax-highlighter';
    import {darcula, docco} from 'react-syntax-highlighter/dist/esm/styles/hljs';

    export const Pagedb82cc22be4f48eaaad72d348dc0c850 = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
    const source = `
...
`
    return (
        <PageLayout>
            <div>
                <TreeSelectWithFormAndNodeRenderers />
            </div>
            <Divider />
            <div>
                <Collapse 
...
export default Pagedb82cc22be4f48eaaad72d348dc0c850;
