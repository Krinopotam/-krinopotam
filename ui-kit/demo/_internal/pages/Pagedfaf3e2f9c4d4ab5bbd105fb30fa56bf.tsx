    ...
    import {TreeSelectDefaultValue} from '../../components/treeSelect/defaultValue';
    import { Divider, Collapse } from 'antd';
    import SyntaxHighlighter from 'react-syntax-highlighter';
    import {darcula, docco} from 'react-syntax-highlighter/dist/esm/styles/hljs';

    export const Pagedfaf3e2f9c4d4ab5bbd105fb30fa56bf = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
    const source = `
import React from 'react';
...
export default Pagedfaf3e2f9c4d4ab5bbd105fb30fa56bf;
