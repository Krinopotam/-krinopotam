    ...
    import {TreeSelectReadOnly} from '../../components/treeSelect/readOnly';
    import { Divider, Collapse } from 'antd';
    import SyntaxHighlighter from 'react-syntax-highlighter';
    import {darcula, docco} from 'react-syntax-highlighter/dist/esm/styles/hljs';

    export const Page1b52456eea7f4d318ec8511fb59c5dde = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
    const source = `
import React from 'react';
...
export const TreeSelectReadOnly = (): React.JSX.Element => {
    return (
        <>
...
export default Page1b52456eea7f4d318ec8511fb59c5dde;
