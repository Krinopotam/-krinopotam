    ...
    import {EditableGridWithAsyncTabulatorGrid} from '../../components/tabulatorGrid/async/editableGridWithAsyncTabulatorGrid';
    import { Divider, Collapse } from 'antd';
    import SyntaxHighlighter from 'react-syntax-highlighter';
    import {darcula, docco} from 'react-syntax-highlighter/dist/esm/styles/hljs';

    export const Pagefb6d20658f5b4bb98a04a92dc636f14c = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
    const source = `
import React from 'react';
...
`
    return (
        <PageLayout>
            <div>
                <EditableGridWithAsyncTabulatorGrid />
            </div>
            <Divider />
            <div>
                <Collapse 
...
export default Pagefb6d20658f5b4bb98a04a92dc636f14c;
