    ...
    import {FormWithAsyncGridWithSelectionForm} from '../../components/dFormModal/async/formWithAsyncGridWithSelectionForm';
    import { Divider, Collapse } from 'antd';
    import SyntaxHighlighter from 'react-syntax-highlighter';
    import {darcula, docco} from 'react-syntax-highlighter/dist/esm/styles/hljs';

    export const Pageab9fb652c0234be7b4e8bc13f2b36268 = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
    const source = `
...
`
    return (
        <PageLayout>
            <div>
                <FormWithAsyncGridWithSelectionForm />
            </div>
            <Divider />
            <div>
                <Collapse 
...
export default Pageab9fb652c0234be7b4e8bc13f2b36268;
