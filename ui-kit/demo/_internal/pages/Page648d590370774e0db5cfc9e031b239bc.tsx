    ...
    import {AsyncWithForm} from '../../components/tabulatorGrid/async/asyncWithForm';
    import { Divider, Collapse } from 'antd';
    import SyntaxHighlighter from 'react-syntax-highlighter';
    import {darcula, docco} from 'react-syntax-highlighter/dist/esm/styles/hljs';

    export const Page648d590370774e0db5cfc9e031b239bc = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
    const source = `
import React from 'react';
...
export default Page648d590370774e0db5cfc9e031b239bc;
