...
export const TagsColumns: ITabulatorColumn[] = [
    ...
    {
        field: 'format', title: 'Формат', headerFilter: true, headerFilterFunc: 'like', formatter: (cell) => {
...
const dataSet = [
    {
        id: '01', name: '1С Зарплата и управление персоналом', shortName: '1С ЗиУП', code: '1C_ZIUP',
        inputs: [
        ...
        outputs: [
            {id: '04', name: 'Товарная накладная', format: {id: '02', label: 'PDF'}},
        ]
    },
    ...
    fieldsProps: {
        tabs1: {
            component: TabsField, tabs: {
                ...
                "Входы": {
                    inputs: {component: TabulatorGridField, columns: TagsColumns, headerFilterHidden:true, height:'320px', layout: 'fitColumns', resizeHeightWithForm:true} as ITabulatorGridFieldProps,
                },
                "Выходы": {
                    outputs: {component: TabulatorGridField, columns: TagsColumns, headerFilterHidden:true, height:'320px', layout: 'fitColumns', resizeHeightWithForm:true},
                }
            }
        }
    }
...
export const TabulatorGridWithComplexForm = (): React.JSX.Element => {
    return (
        <TabulatorGrid columns={columns} dataSet={dataSet} layout={'fitColumns'} movableColumns editFormProps={editFormProps} height={"100%"}/>
    );
};
