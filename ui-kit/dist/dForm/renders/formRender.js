...
export const FormRender = ({ formProps, formApi, formButtons }) => {
    ...
    return (React.createElement("div", { className: (_b = formProps.containerClassName) !== null && _b !== void 0 ? _b : '' },
        React.createElement(LoadingContainer, { isLoading: model.isFormFetching() || (model.isFormSubmitting() && !formProps.confirmChanges), notHideContent: true },
            React.createElement(ButtonsRowWrapper, null,
                React.createElement(Form, { colon: false, className: formProps.className, name: model.getFormId(), labelCol: labelCol, wrapperCol: wrapperCol, autoComplete: "off", labelAlign: formProps.labelAlign, layout: formProps.layout === 'horizontal' ? 'horizontal' : 'vertical', requiredMark: formProps.requiredMark },
