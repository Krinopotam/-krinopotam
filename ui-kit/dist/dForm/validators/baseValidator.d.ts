...
export interface IRuleCustom {
    type: 'custom';
    callback: (value: unknown, formModel: DModel) => string;
}
...
export declare class BaseValidator {
    validate(values: Record<string, unknown>, formModel: DModel, validationRules?: Record<string, IRuleType[]>, hidden?: Record<string, boolean>): Record<string, string>;
    validateValue(value: unknown, formModel: DModel, validationRules?: IRuleType[]): string;
