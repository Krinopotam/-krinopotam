...
const useApiSetValue = (setValue, api) => {
    return useCallback((value) => {
        ...
        if (!newVal) {
            ...
            (_d = treeProps === null || treeProps === void 0 ? void 0 : treeProps.onChange) === null || _d === void 0 ? void 0 : _d.call(treeProps, HelpersObjects.isArray(newVal) && newVal.length > 0 ? newVal[0] : newVal);
        }
        else {
