...
export class CustomComponentConfig<T>  extends BaseComponentConfig<T> {
    ...
    constructor(id: keyof T) {
        super(id);
        this._config.component = CustomComponent; 
    }
    ...
    onRender(value: IDFormFieldCustomProps['onRender']) {
        this._config.onRender = value;
        return this;
    }
    ...
    /** Get field config */
    getConfig() {
        return this._config as unknown as IDFormFieldCustomProps
    }
}