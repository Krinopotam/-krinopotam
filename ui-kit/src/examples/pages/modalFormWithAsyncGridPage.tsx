    ...
    import {ModalFormWithAsyncGrid} from '../components/modalFormWithAsyncGrid';
    import { Divider } from 'antd';
    import SyntaxHighlighter from 'react-syntax-highlighter';
    import {darcula, docco} from 'react-syntax-highlighter/dist/esm/styles/hljs';

    export const ModalFormWithAsyncGridPage = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
...
import {DFormModal, IDFormModalApi} from '../../dynamic-form-modal';
import {DFormModalConfig} from '../../dynamic-form-modal/configBuilder';
import {InputComponentConfig} from '../../dynamic-form/configBuilder/inputComponentConfig';
import {NumberComponentConfig} from '../../dynamic-form/configBuilder/numberComponentConfig';
import {IReactTabulatorProps, IGridRowData} from "../../tabulator-grid";
import {TabulatorGridComponentConfig} from '../../dynamic-form/configBuilder/tabulatorGridComponentConfig';
