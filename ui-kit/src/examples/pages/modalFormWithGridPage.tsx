    ...
    export const ModalFormWithGridPage = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
...
import {DFormModalConfig, NumberComponentConfig, TabulatorGridComponentConfig, InputComponentConfig} from '../../dynamic-form-modal/configBuilder';
