    ...
    export const TabulatorGridTreeWithFormPage = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
...
import TabulatorGrid, {IReactTabulatorProps, IGridRowData} from '../../tabulator-grid';
