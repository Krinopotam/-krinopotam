    ...
    export const TabulatorGridChangeDataSetPage = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
...
import TabulatorGrid, {IReactTabulatorProps, IGridProps, IGridApi, IGridRowData} from '../../tabulator-grid';
