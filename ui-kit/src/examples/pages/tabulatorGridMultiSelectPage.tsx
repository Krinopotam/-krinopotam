    ...
    import {TabulatorGridMultiSelect} from '../components/tabulatorGridMultiSelect';
    import { Divider } from 'antd';
    import SyntaxHighlighter from 'react-syntax-highlighter';
    import {darcula, docco} from 'react-syntax-highlighter/dist/esm/styles/hljs';

    export const TabulatorGridMultiSelectPage = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
