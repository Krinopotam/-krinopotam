    ...
    export const TabulatorGridWithFormAsyncPage = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
    const source = `// noinspection DuplicatedCode

import React from 'react';
import {DFormModalConfig, NumberComponentConfig, InputComponentConfig} from '../../dynamic-form-modal/configBuilder';
