    ...
    export const TreeSelectWithFormAsyncPage = (props: {darkMode: boolean}): React.JSX.Element => {
    // language=text
...
import {InputComponentConfig, DFormModalConfig} from '../../dynamic-form-modal/configBuilder';
