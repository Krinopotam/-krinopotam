...
export const TreeSelectRender = ({api, treeSelectProps, antdTreeSelectProps}: {api: ITreeSelectApi; treeSelectProps: ITreeSelectProps, antdTreeSelectProps:IAntTreeSelectProps}): React.JSX.Element => {
    ...
    return (
        <AntdTreeSelect
            ...
            treeNodeLabelProp={treeSelectProps.selectedLabelProp ? treeSelectProps.selectedLabelProp : treeSelectProps.labelRender ? '__label' : treeSelectProps.fieldNames?.title ?? 'title'} //Selected value label. Will render as content of select. Default: title
            ...
            notFoundContent={treeSelectProps.notFoundContent ?? <NotFound fetching={api.getIsFetching()} error={api.getFetchError()} minSymbols={api.getMinSymbols()} />}
