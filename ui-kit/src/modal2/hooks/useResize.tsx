...
import {IModalProps} from "@src/modal2";
...
export const useResize = (
    props: IModalProps,
    setModalSize: (size: { width: number | string | undefined; height: number | string | undefined }) => void,
    ...
    }, [initialDragState.element, setDragging, setModalSize]);
