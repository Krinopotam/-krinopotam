...
const options = {
    ...
    dFormModal: {
        modulePath: '../../../dynamic-form-modal/src/dFormModal.tsx',
...
function getFormModalClassProps(componentName) {
    ...
    return {
        ...
        imports: {
            IDFormProps: '@krinopotam/ui-dynamic-form',
            IDFormFieldProps: '@krinopotam/ui-dynamic-form/components/baseComponent',
            IRuleType: '@krinopotam/ui-dynamic-form/validators/baseValidator',
            DFormConfig: '@krinopotam/ui-dynamic-form/configBuilder/dFormConfig',
            BaseComponentConfig: '@krinopotam/ui-dynamic-form/configBuilder/baseComponentConfig',
