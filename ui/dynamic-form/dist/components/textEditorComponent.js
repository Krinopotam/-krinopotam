...
export const TextEditorComponent = ({ formApi, fieldName, fieldProps }) => {
    ...
    return (React.createElement(ReactQuill, { theme: "snow", value: value, onChange: onChange, onBlur: onBlur, modules: modules, formats: formats, readOnly: formApi.model.isFieldReadOnly(fieldName) || formApi.model.isFieldDisabled(fieldName) }));
};
