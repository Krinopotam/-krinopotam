...
import { usePlainValuesToNodes, useValueConvertor } from './valueConvertor';
...
const useApiSetValue = (setValue, api) => {
    return useCallback((value) => {
        ...
        if (!newVal) {
            (_d = (_c = treeProps.callbacks) === null || _c === void 0 ? void 0 : _c.onChange) === null || _d === void 0 ? void 0 : _d.call(_c, null);
        }
        else if (!treeProps.multiple) {
            (_f = (_e = treeProps.callbacks) === null || _e === void 0 ? void 0 : _e.onChange) === null || _f === void 0 ? void 0 : _f.call(_e, HelpersObjects.isArray(newVal) && newVal.length > 0 ? newVal[0] : newVal);
        }
        else {
            (_h = (_g = treeProps.callbacks) === null || _g === void 0 ? void 0 : _g.onChange) === null || _h === void 0 ? void 0 : _h.call(_g, newVal || []);
        }
    }, [api, setValue]);
};
...
const useAddNodes = (api) => {
    return useCallback((parentNode, newNodes) => {
        var _a, _b, _c, _d, _e;
        const _newNodes = HelpersObjects.isArray(newNodes) ? newNodes : [newNodes];
        const treeProps = api.getProps();
        const keyField = (_b = (_a = treeProps.fieldNames) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : 'id';
        ...
        for (const _newNode of _newNodes) {
            if (!_newNode[keyField])
                _newNode[keyField] = HelpersStrings.getUuid();
        }
...
const useUpdateNodes = (api) => {
    return useCallback((updatedNodes) => {
        var _a, _b, _c, _d, _e;
        const _updatedNodes = HelpersObjects.isArray(updatedNodes) ? updatedNodes : [updatedNodes];
        const treeProps = api.getProps();
        const keyField = (_b = (_a = treeProps.fieldNames) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : 'id';
        const childrenField = (_d = (_c = treeProps.fieldNames) === null || _c === void 0 ? void 0 : _c.children) !== null && _d !== void 0 ? _d : 'children';
...
const useDeleteNodes = (api) => {
    return useCallback((removeNodes) => {
        var _a, _b, _c, _d, _e;
        const _removeNodes = HelpersObjects.isArray(removeNodes) ? removeNodes : [removeNodes];
        const treeProps = api.getProps();
        const keyField = (_b = (_a = treeProps.fieldNames) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : 'id';
        const childrenField = (_d = (_c = treeProps.fieldNames) === null || _c === void 0 ? void 0 : _c.children) !== null && _d !== void 0 ? _d : 'children';
