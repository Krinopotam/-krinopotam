...
import {DFormModal, IDFormModalProps} from '@krinopotam/ui-dynamic-form-modal';
...
import {ButtonsRow, IButtonsRowApi, IFormButtons} from '@krinopotam/ui-buttons-row';
...
export const TreeSelect = (props: ITreeSelectProps): React.JSX.Element => {
    ...
    const [componentId] = useState(treeProps.treeSelectId ?? 'treeSelect-' + HelpersStrings.getUuid());
