...
export const LoadingContainer = ({ isLoading, error, retryHandler, children, skeleton, notHideContent, caption, }) => {
    ...
    return (React.createElement(LoadingError, { errorMessage: error === null || error === void 0 ? void 0 : error.message, retryHandler: retryHandler }, React.createElement(Spin, { spinning: isLoading, delay: 0, tip: tip }, isLoading && !notHideContent ? (React.createElement(React.Fragment, null, skeleton !== null && skeleton !== void 0 ? skeleton : null,
